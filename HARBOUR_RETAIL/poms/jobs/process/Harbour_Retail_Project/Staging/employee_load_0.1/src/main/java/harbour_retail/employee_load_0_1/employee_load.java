...
package harbour_retail.employee_load_0_1;
...
/**
 * Job: employee_load Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class employee_load implements TalendJob {
...
public String getCustom_error_message(){
	...
	private final String jobName = "employee_load";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				employee_load.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(employee_load.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:wGgaC/dfbua3RpiGydiI4/14eLi2zwC/dpu2h4K3rqS2X2jy+bBlbV8=");
...
public static class Employee_Success_RecordsStruct implements routines.system.IPersistableRow<Employee_Success_RecordsStruct> {
    final static byte[] commonByteArrayLock_HARBOUR_RETAIL_employee_load = new byte[0];
    static byte[] commonByteArray_HARBOUR_RETAIL_employee_load = new byte[0];
	...
	public boolean equals(Object obj) {
		...
		final Employee_Success_RecordsStruct other = (Employee_Success_RecordsStruct) obj;
	...
	public void copyDataTo(Employee_Success_RecordsStruct other) {
	...
	public void copyKeysDataTo(Employee_Success_RecordsStruct other) {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_HARBOUR_RETAIL_employee_load.length) {
				if(length < 1024 && commonByteArray_HARBOUR_RETAIL_employee_load.length == 0) {
   					commonByteArray_HARBOUR_RETAIL_employee_load = new byte[1024];
				} else {
   					commonByteArray_HARBOUR_RETAIL_employee_load = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_HARBOUR_RETAIL_employee_load, 0, length);
			strReturn = new String(commonByteArray_HARBOUR_RETAIL_employee_load, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_HARBOUR_RETAIL_employee_load, 0, length);
			strReturn = new String(commonByteArray_HARBOUR_RETAIL_employee_load, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_HARBOUR_RETAIL_employee_load) {
     ...
     * Compare keys
     */
    public int compareTo(Employee_Success_RecordsStruct other) {
...
public static class Employee_Rejected_RecordsStruct implements routines.system.IPersistableRow<Employee_Rejected_RecordsStruct> {
    final static byte[] commonByteArrayLock_HARBOUR_RETAIL_employee_load = new byte[0];
    static byte[] commonByteArray_HARBOUR_RETAIL_employee_load = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final Employee_Rejected_RecordsStruct other = (Employee_Rejected_RecordsStruct) obj;
	...
	public void copyDataTo(Employee_Rejected_RecordsStruct other) {
	...
	public void copyKeysDataTo(Employee_Rejected_RecordsStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(Employee_Rejected_RecordsStruct other) {
...
public static class ComplianceRejectStruct implements routines.system.IPersistableRow<ComplianceRejectStruct> {
    final static byte[] commonByteArrayLock_HARBOUR_RETAIL_employee_load = new byte[0];
    static byte[] commonByteArray_HARBOUR_RETAIL_employee_load = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final ComplianceRejectStruct other = (ComplianceRejectStruct) obj;
	...
	public void copyDataTo(ComplianceRejectStruct other) {
	...
	public void copyKeysDataTo(ComplianceRejectStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(ComplianceRejectStruct other) {
...
Employee_Success_RecordsStruct Employee_Success_Records = new Employee_Success_RecordsStruct();
Employee_Rejected_RecordsStruct Employee_Rejected_Records = new Employee_Rejected_RecordsStruct();
row5Struct row5 = new row5Struct();
ComplianceRejectStruct ComplianceReject = new ComplianceRejectStruct();
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"Employee_Success_Records");
					}
...
String tableName_tDBOutput_1 = "staging_employee";
...
int count_tDBOutput_1=0;
                                ...
                                java.sql.DatabaseMetaData dbMetaData_tDBOutput_1 = conn_tDBOutput_1.getMetaData();
                                    java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables("Harbour_Retail", null, null, new String[]{"TABLE"});
                                boolean whetherExist_tDBOutput_1 = false;
                                while(rsTable_tDBOutput_1.next()) {
                                    String table_tDBOutput_1 = rsTable_tDBOutput_1.getString("TABLE_NAME");
                                    if(table_tDBOutput_1.equalsIgnoreCase("staging_employee")) {
                                ...
                                try(java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
                                    stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1 + "`(`Emp_ID` INT(3)  ,`First_Name` VARCHAR(9)  ,`Surname` VARCHAR(7)  ,`City` VARCHAR(9)  ,`Department` VARCHAR(50)  ,`Salary` INT(5)  ,`Country` VARCHAR(5)  ,`Address` VARCHAR(19)  ,`ZIP_Code` INT(0)  ,`Employed_Since` DATETIME ,`Manager` VARCHAR(50)  ,primary key(`Emp_ID`))");
                                }

				String insert_tDBOutput_1 = "INSERT INTO `" + "staging_employee" + "` (`Emp_ID`,`First_Name`,`Surname`,`City`,`Department`,`Salary`,`Country`,`Address`,`ZIP_Code`,`Employed_Since`,`Manager`) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
 ...
 */
	...
	currentComponent="tDBOutput_3";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"Employee_Rejected_Records");
					}
...
String tableName_tDBOutput_3 = "STAGING_EMPLOYEE_REJECT";
...
int count_tDBOutput_3=0;
				...
				String insert_tDBOutput_3 = "INSERT INTO `" + "STAGING_EMPLOYEE_REJECT" + "` (`Emp_ID`,`First_Name`,`Surname`,`City`,`Department`,`Salary`,`Country`,`Address`,`ZIP_Code`,`Employed_Since`,`Manager`,`Error_Code`,`Error_Message`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
Employee_Success_RecordsStruct Employee_Success_Records_tmp = new Employee_Success_RecordsStruct();
Employee_Rejected_RecordsStruct Employee_Rejected_Records_tmp = new Employee_Rejected_RecordsStruct();
// ###############################
 ...
 */
	...
	currentComponent="tDBOutput_2";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"ComplianceReject");
					}
...
String tableName_tDBOutput_2 = "STAGING_EMPLOYEE_REJECT";
...
int count_tDBOutput_2=0;
				...
				String insert_tDBOutput_2 = "INSERT INTO `" + "STAGING_EMPLOYEE_REJECT" + "` (`Emp_ID`,`First_Name`,`Surname`,`Department`,`Salary`,`Address`,`ZIP_Code`,`City`,`Country`,`Employed_Since`,`Manager`,`Error_Code`,`Error_Message`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
// ###############################
// # Outputs initialization
ComplianceRejectStruct ComplianceReject_tmp = new ComplianceRejectStruct();
// ###############################
 ...
 */
    ...
    if ((row1.Emp_ID == null) || ("".equals(row1.Emp_ID))) {
        ...
        errorMessageThrough += "|empty or null";
            ...
            errorCodeThrough = 0;
            resultErrorMessageThrough = handleErrorMessage(errorMessageThrough,resultErrorMessageThrough,"Emp_ID:");
            errorMessageThrough = "";
    // validate nullable (empty as null)
    if ((row1.First_Name == null) || ("".equals(row1.First_Name))) {
        ifPassedThrough = false;
        errorCodeThrough += 4;
        errorMessageThrough += "|empty or null";
    }    try {
        ...
        row1.First_Name != null
            ...
            String tester_tSchemaComplianceCheck_1 = String.valueOf(row1.First_Name);
        }
    } catch(java.lang.Exception e) {
globalMap.put("tSchemaComplianceCheck_1_ERROR_MESSAGE",e.getMessage());
        ...
        errorMessageThrough += "|wrong type";
            ...
            resultErrorCodeThrough = handleErrorCode(errorCodeThrough,resultErrorCodeThrough);
            errorCodeThrough = 0;
            resultErrorMessageThrough = handleErrorMessage(errorMessageThrough,resultErrorMessageThrough,"First_Name:");
            errorMessageThrough = "";    try {
        if(
        row1.Surname != null
        && (!"".equals(row1.Surname))
        ) {
            String tester_tSchemaComplianceCheck_1 = String.valueOf(row1.Surname);
        }
    } catch(java.lang.Exception e) {
globalMap.put("tSchemaComplianceCheck_1_ERROR_MESSAGE",e.getMessage());
        ifPassedThrough = false;
        ...
        errorMessageThrough += "|wrong type";
            ...
            resultErrorCodeThrough = handleErrorCode(errorCodeThrough,resultErrorCodeThrough);
            errorCodeThrough = 0;
            resultErrorMessageThrough = handleErrorMessage(errorMessageThrough,resultErrorMessageThrough,"Surname:");
            errorMessageThrough = "";
    // validate nullable (empty as null)
    if ((row1.Department == null) || ("".equals(row1.Department))) {
        ifPassedThrough = false;
        errorCodeThrough += 4;
        errorMessageThrough += "|empty or null";
    }    try {
        ...
        row1.Department != null
            ...
            String tester_tSchemaComplianceCheck_1 = String.valueOf(row1.Department);
        }
    } catch(java.lang.Exception e) {
globalMap.put("tSchemaComplianceCheck_1_ERROR_MESSAGE",e.getMessage());
        ifPassedThrough = false;
        ...
        errorMessageThrough += "|wrong type";
            ...
            resultErrorCodeThrough = handleErrorCode(errorCodeThrough,resultErrorCodeThrough);
            errorCodeThrough = 0;
            resultErrorMessageThrough = handleErrorMessage(errorMessageThrough,resultErrorMessageThrough,"Department:");
            errorMessageThrough = "";
    // validate nullable (empty as null)
    if ((row1.Salary == null) || ("".equals(row1.Salary))) {
        ifPassedThrough = false;
        errorCodeThrough += 4;
        errorMessageThrough += "|empty or null";
    }
            resultErrorCodeThrough = handleErrorCode(errorCodeThrough,resultErrorCodeThrough);
            errorCodeThrough = 0;
            resultErrorMessageThrough = handleErrorMessage(errorMessageThrough,resultErrorMessageThrough,"Salary:");
            errorMessageThrough = "";
    // validate nullable (empty as null)
...
globalMap.put("tSchemaComplianceCheck_1_ERROR_MESSAGE",e.getMessage());
        ...
        errorMessageThrough += "|wrong type";
            ...
            errorMessageThrough = "";
    // validate nullable (empty as null)
    if ((row1.Employed_Since == null) || ("".equals(row1.Employed_Since))) {
        ifPassedThrough = false;
        errorCodeThrough += 4;
        errorMessageThrough += "|empty or null";
    }
            resultErrorCodeThrough = handleErrorCode(errorCodeThrough,resultErrorCodeThrough);
            errorCodeThrough = 0;
            resultErrorMessageThrough = handleErrorMessage(errorMessageThrough,resultErrorMessageThrough,"Employed_Since:");
            errorMessageThrough = "";
    // validate nullable (empty as null)
    if ((row1.Manager == null) || ("".equals(row1.Manager))) {
        ifPassedThrough = false;
        errorCodeThrough += 4;
        errorMessageThrough += "|empty or null";
    }    try {
        ...
        row1.Manager != null
            ...
            String tester_tSchemaComplianceCheck_1 = String.valueOf(row1.Manager);
        }
    } catch(java.lang.Exception e) {
globalMap.put("tSchemaComplianceCheck_1_ERROR_MESSAGE",e.getMessage());
        ifPassedThrough = false;
        ...
        errorMessageThrough += "|wrong type";
            ...
            resultErrorCodeThrough = handleErrorCode(errorCodeThrough,resultErrorCodeThrough);
            errorCodeThrough = 0;
            resultErrorMessageThrough = handleErrorMessage(errorMessageThrough,resultErrorMessageThrough,"Manager:");
            errorMessageThrough = "";
        }
    }
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:x7iwqB60IoivUPRzng5sLI91WJ4YJv0m/o2pIg==");
		...
		Object source_tFileInputExcel_1 = "/Users/godzilla/Desktop/Projects/Data Harbour Retail/Input Data/Employee.xlsx";
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row1.Emp_ID = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				row1.Emp_ID = null;
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Surname";

				row1.Surname = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row1.Surname = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row1.Salary = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				row1.Salary = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Employed_Since";
				...
				if(9<actual_end_column_tFileInputExcel_1){
					try{
						if(row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1+ start_column_tFileInputExcel_1).getCellType() == org.apache.poi.ss.usermodel.CellType.NUMERIC && org.apache.poi.ss.usermodel.DateUtil.isCellDateFormatted(row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1+ start_column_tFileInputExcel_1))){
							row1.Employed_Since = row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1+ start_column_tFileInputExcel_1).getDateCellValue();
						}
						else{
                            ...
                            if(tempDate_tFileInputExcel_1.after((new SimpleDateFormat("yyyy/MM/dd hh:mm:ss.SSS")).parse("9999/12/31 23:59:59.999"))||tempDate_tFileInputExcel_1.before((new SimpleDateFormat("yyyy/MM/dd")).parse("1900/01/01"))){
                                ...
                                row1.Employed_Since = tempDate_tFileInputExcel_1;
                            }
						}
					}catch(java.lang.Exception e){
globalMap.put("tFileInputExcel_1_ERROR_MESSAGE",e.getMessage());
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Manager";

				row1.Manager = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row1.Manager = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
...
if(row1 != null) { 
	...
	if (rsvUtil_tSchemaComplianceCheck_1.ifPassedThrough) {
		row4 = new row4Struct();
		row4.Emp_ID = row1.Emp_ID;
		row4.First_Name = row1.First_Name;
		row4.Surname = row1.Surname;
		row4.Department = row1.Department;
		row4.Salary = row1.Salary;
		row4.Address = row1.Address;
		row4.ZIP_Code = row1.ZIP_Code;
		row4.City = row1.City;
		row4.Country = row1.Country;
		row4.Employed_Since = row1.Employed_Since;
		row4.Manager = row1.Manager;
	}
	if (!rsvUtil_tSchemaComplianceCheck_1.ifPassedThrough) {
		row5 = new row5Struct();
		row5.Emp_ID = row1.Emp_ID;
		row5.First_Name = row1.First_Name;
		row5.Surname = row1.Surname;
		row5.Department = row1.Department;
		row5.Salary = row1.Salary;
		row5.Address = row1.Address;
		row5.ZIP_Code = row1.ZIP_Code;
		row5.City = row1.City;
		row5.Country = row1.Country;
		row5.Employed_Since = row1.Employed_Since;
		row5.Manager = row1.Manager;
		row5.errorCode = String.valueOf(rsvUtil_tSchemaComplianceCheck_1.resultErrorCodeThrough);
...
row6 = null;			
finder_tUniqRow_1.Emp_ID = row4.Emp_ID;	
finder_tUniqRow_1.hashCodeDirty = true;
if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
		KeyStruct_tUniqRow_1 new_tUniqRow_1 = new KeyStruct_tUniqRow_1();

		
new_tUniqRow_1.Emp_ID = row4.Emp_ID;
		
		keystUniqRow_1.add(new_tUniqRow_1);if(row6 == null){ 
	
	row6 = new row6Struct();
}row6.Emp_ID = row4.Emp_ID;			row6.First_Name = row4.First_Name;			row6.Surname = row4.Surname;			row6.Department = row4.Department;			row6.Salary = row4.Salary;			row6.Address = row4.Address;			row6.ZIP_Code = row4.ZIP_Code;			row6.City = row4.City;			row6.Country = row4.Country;			row6.Employed_Since = row4.Employed_Since;			row6.Manager = row4.Manager;					
...
Var.Department_Check = (row6.Department.equalsIgnoreCase("IT") || 
row6.Department.equalsIgnoreCase("Sales")) ?"Valid Record"
:(context.custom_error_message = "Mismatched Department") ;
Var.Manager_Check = row6.Manager.equalsIgnoreCase("Sanjay") ?"Valid Record"
:(context.custom_error_message = "Wrong Manager") ;// ###############################
        // ###############################
        // # Output tables

Employee_Success_Records = null;
Employee_Rejected_Records = null;

boolean rejected_tMap_1 = true;

// # Output table : 'Employee_Success_Records'
// # Filter conditions 
if( 

Var.Department_Check.equals("Valid Record") &&  Var.Manager_Check.equals("Valid Record")

 ) {
rejected_tMap_1 = false;
Employee_Success_Records_tmp.Emp_ID = row6.Emp_ID ;
Employee_Success_Records_tmp.First_Name = row6.First_Name ;
Employee_Success_Records_tmp.Surname = row6.Surname ;
Employee_Success_Records_tmp.City = row6.City ;
Employee_Success_Records_tmp.Department = row6.Department ;
Employee_Success_Records_tmp.Salary = row6.Salary ;
Employee_Success_Records_tmp.Country = row6.Country ;
Employee_Success_Records_tmp.Address = row6.Address ;
Employee_Success_Records_tmp.ZIP_Code = row6.ZIP_Code ;
Employee_Success_Records_tmp.Employed_Since = row6.Employed_Since ;
Employee_Success_Records_tmp.Manager =  row6.Manager ;
Employee_Success_Records = Employee_Success_Records_tmp;
} // closing filter/reject
// ###### START REJECTS ##### 

// # Output reject table : 'Employee_Rejected_Records'
// # Filter conditions 
if( rejected_tMap_1 ) {
Employee_Rejected_Records_tmp.Emp_ID = row6.Emp_ID ;
Employee_Rejected_Records_tmp.First_Name = row6.First_Name ;
Employee_Rejected_Records_tmp.Surname = row6.Surname ;
Employee_Rejected_Records_tmp.City = row6.City ;
Employee_Rejected_Records_tmp.Department = row6.Department ;
Employee_Rejected_Records_tmp.Salary = row6.Salary ;
Employee_Rejected_Records_tmp.Country = row6.Country ;
Employee_Rejected_Records_tmp.Address = row6.Address ;
Employee_Rejected_Records_tmp.ZIP_Code = row6.ZIP_Code ;
Employee_Rejected_Records_tmp.Employed_Since = row6.Employed_Since ;
Employee_Rejected_Records_tmp.Manager = row6.Manager ;
Employee_Rejected_Records_tmp.Error_Code = "2" ;
Employee_Rejected_Records_tmp.Error_Message = context.custom_error_message ;
Employee_Rejected_Records = Employee_Rejected_Records_tmp;
} // closing filter/reject
// ###############################
 ...
 */
// Start of branch "Employee_Success_Records"
if(Employee_Success_Records != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                            if(Employee_Success_Records.Emp_ID == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(1, Employee_Success_Records.Emp_ID);
}

                            if(Employee_Success_Records.First_Name == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, Employee_Success_Records.First_Name);
}

                            if(Employee_Success_Records.Surname == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, Employee_Success_Records.Surname);
}

                            if(Employee_Success_Records.City == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, Employee_Success_Records.City);
}

                            if(Employee_Success_Records.Department == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(5, Employee_Success_Records.Department);
}

                            if(Employee_Success_Records.Salary == null) {
pstmt_tDBOutput_1.setNull(6, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(6, Employee_Success_Records.Salary);
}

                            if(Employee_Success_Records.Country == null) {
pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(7, Employee_Success_Records.Country);
}

                            if(Employee_Success_Records.Address == null) {
pstmt_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(8, Employee_Success_Records.Address);
}

                            if(Employee_Success_Records.ZIP_Code == null) {
pstmt_tDBOutput_1.setNull(9, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(9, Employee_Success_Records.ZIP_Code);
}

                            if(Employee_Success_Records.Employed_Since != null) {
date_tDBOutput_1 = Employee_Success_Records.Employed_Since.getTime();
...
pstmt_tDBOutput_1.setNull(10, java.sql.Types.DATE);
                            ...
                            if(Employee_Success_Records.Manager == null) {
pstmt_tDBOutput_1.setNull(11, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(11, Employee_Success_Records.Manager);
}
...
} // End of branch "Employee_Success_Records"




// Start of branch "Employee_Rejected_Records"
if(Employee_Rejected_Records != null) { 
	...
	currentComponent="tDBOutput_3";
        ...
        whetherReject_tDBOutput_3 = false;
                            if(Employee_Rejected_Records.Emp_ID == null) {
pstmt_tDBOutput_3.setNull(1, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_3.setInt(1, Employee_Rejected_Records.Emp_ID);
}

                            if(Employee_Rejected_Records.First_Name == null) {
pstmt_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(2, Employee_Rejected_Records.First_Name);
}

                            if(Employee_Rejected_Records.Surname == null) {
pstmt_tDBOutput_3.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(3, Employee_Rejected_Records.Surname);
}

                            if(Employee_Rejected_Records.City == null) {
pstmt_tDBOutput_3.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(4, Employee_Rejected_Records.City);
}

                            if(Employee_Rejected_Records.Department == null) {
pstmt_tDBOutput_3.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(5, Employee_Rejected_Records.Department);
}

                            if(Employee_Rejected_Records.Salary == null) {
pstmt_tDBOutput_3.setNull(6, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_3.setInt(6, Employee_Rejected_Records.Salary);
}

                            if(Employee_Rejected_Records.Country == null) {
pstmt_tDBOutput_3.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(7, Employee_Rejected_Records.Country);
}

                            if(Employee_Rejected_Records.Address == null) {
pstmt_tDBOutput_3.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(8, Employee_Rejected_Records.Address);
}

                            if(Employee_Rejected_Records.ZIP_Code == null) {
pstmt_tDBOutput_3.setNull(9, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_3.setInt(9, Employee_Rejected_Records.ZIP_Code);
}

                            if(Employee_Rejected_Records.Employed_Since != null) {
date_tDBOutput_3 = Employee_Rejected_Records.Employed_Since.getTime();
if(date_tDBOutput_3 < year1_tDBOutput_3 || date_tDBOutput_3 >= year10000_tDBOutput_3) {
pstmt_tDBOutput_3.setString(10, "0000-00-00 00:00:00");
} else {pstmt_tDBOutput_3.setTimestamp(10, new java.sql.Timestamp(date_tDBOutput_3));
}
} else {
pstmt_tDBOutput_3.setNull(10, java.sql.Types.DATE);
}

                            if(Employee_Rejected_Records.Manager == null) {
pstmt_tDBOutput_3.setNull(11, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(11, Employee_Rejected_Records.Manager);
}

                            if(Employee_Rejected_Records.Error_Code == null) {
pstmt_tDBOutput_3.setNull(12, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(12, Employee_Rejected_Records.Error_Code);
}

                            if(Employee_Rejected_Records.Error_Message == null) {
pstmt_tDBOutput_3.setNull(13, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(13, Employee_Rejected_Records.Error_Message);
}
...
} // End of branch "Employee_Rejected_Records"
...
ComplianceReject = null;


// # Output table : 'ComplianceReject'
ComplianceReject_tmp.Emp_ID = row5.Emp_ID ;
ComplianceReject_tmp.First_Name = row5.First_Name ;
ComplianceReject_tmp.Surname = row5.Surname ;
ComplianceReject_tmp.Department = row5.Department ;
ComplianceReject_tmp.Salary = row5.Salary ;
ComplianceReject_tmp.Address = row5.Address ;
ComplianceReject_tmp.ZIP_Code = row5.ZIP_Code ;
ComplianceReject_tmp.City = row5.City ;
ComplianceReject_tmp.Country = row5.Country ;
ComplianceReject_tmp.Employed_Since = row5.Employed_Since ;
ComplianceReject_tmp.Manager = row5.Manager ;
ComplianceReject_tmp.Error_Code = row5.errorCode ;
ComplianceReject_tmp.Error_Message = row5.errorMessage ;
ComplianceReject = ComplianceReject_tmp;
// ###############################
 ...
 */
// Start of branch "ComplianceReject"
if(ComplianceReject != null) { 
	...
	currentComponent="tDBOutput_2";
        ...
        whetherReject_tDBOutput_2 = false;
                            if(ComplianceReject.Emp_ID == null) {
pstmt_tDBOutput_2.setNull(1, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_2.setInt(1, ComplianceReject.Emp_ID);
}

                            if(ComplianceReject.First_Name == null) {
pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(2, ComplianceReject.First_Name);
}

                            if(ComplianceReject.Surname == null) {
pstmt_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(3, ComplianceReject.Surname);
}

                            if(ComplianceReject.Department == null) {
pstmt_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(4, ComplianceReject.Department);
}

                            if(ComplianceReject.Salary == null) {
pstmt_tDBOutput_2.setNull(5, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_2.setInt(5, ComplianceReject.Salary);
}

                            if(ComplianceReject.Address == null) {
pstmt_tDBOutput_2.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(6, ComplianceReject.Address);
}

                            if(ComplianceReject.ZIP_Code == null) {
pstmt_tDBOutput_2.setNull(7, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_2.setInt(7, ComplianceReject.ZIP_Code);
}

                            if(ComplianceReject.City == null) {
pstmt_tDBOutput_2.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(8, ComplianceReject.City);
}

                            if(ComplianceReject.Country == null) {
pstmt_tDBOutput_2.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(9, ComplianceReject.Country);
}

                            if(ComplianceReject.Employed_Since != null) {
date_tDBOutput_2 = ComplianceReject.Employed_Since.getTime();
...
pstmt_tDBOutput_2.setNull(10, java.sql.Types.DATE);
                            ...
                            if(ComplianceReject.Manager == null) {
pstmt_tDBOutput_2.setNull(11, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(11, ComplianceReject.Manager);
}

                            if(ComplianceReject.Error_Code == null) {
pstmt_tDBOutput_2.setNull(12, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(12, ComplianceReject.Error_Code);
}

                            if(ComplianceReject.Error_Message == null) {
pstmt_tDBOutput_2.setNull(13, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(13, ComplianceReject.Error_Message);
}
...
} // End of branch "ComplianceReject"
 ...
 */
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"Employee_Success_Records");
			  	}
 ...
 */
	...
	nb_line_rejected_tDBOutput_3=nb_line_rejected_tDBOutput_3 + rejectedCount_tDBOutput_3;
        ...
        globalMap.put("tDBOutput_3_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_3);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"Employee_Rejected_Records");
			  	}
 ...
 */
	...
	nb_line_rejected_tDBOutput_2=nb_line_rejected_tDBOutput_2 + rejectedCount_tDBOutput_2;
        ...
        globalMap.put("tDBOutput_2_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_2);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"ComplianceReject");
			  	}
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		obj_tRunJob_2 = ((Integer)globalMap.get("tFileInputExcel_1_NB_LINE"));
		if(obj_tRunJob_2!=null) {
			if (obj_tRunJob_2.getClass().getName().equals("java.util.Date")) {
		...
		obj_tRunJob_2 = ((Integer)globalMap.get("tDBOutput_1_NB_LINE"));
		if(obj_tRunJob_2!=null) {
			if (obj_tRunJob_2.getClass().getName().equals("java.util.Date")) {
		...
		obj_tRunJob_2 = ((Integer)globalMap.get("tDBOutput_2_NB_LINE")) + ((Integer)globalMap.get("tDBOutput_3_NB_LINE"));
		if(obj_tRunJob_2!=null) {
			if (obj_tRunJob_2.getClass().getName().equals("java.util.Date")) {
 ...
 */
    ...
    public static void main(String[] args){
        final employee_load employee_loadClass = new employee_load();

        int exitCode = employee_loadClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = employee_load.class.getClassLoader().getResourceAsStream("harbour_retail/employee_load_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = employee_load.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : employee_load");
        }
...
/************************************************************************************************
 *     241869 characters generated by Talend Open Studio for Data Integration 
 *     on the September 21, 2024, 6:04:14 PM EEST
 ************************************************************************************************/