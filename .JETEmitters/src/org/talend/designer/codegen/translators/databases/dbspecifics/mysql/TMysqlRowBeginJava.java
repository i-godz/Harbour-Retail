...
public class TMysqlRowBeginJava
{
  ...
  protected final String TEXT_100 = " + \"?allowLoadLocalInfile=true\";";
  protected final String TEXT_101 = NL + "        String properties_";
  protected final String TEXT_102 = ";" + NL + "        if (properties_";
  protected final String TEXT_103 = " == null || properties_";
  protected final String TEXT_104 = ".trim().length() == 0) {" + NL + "            properties_";
  protected final String TEXT_105 = " = \"allowLoadLocalInfile=true\";" + NL + "        }else {" + NL + "            if (!properties_";
  protected final String TEXT_106 = ".contains(\"allowLoadLocalInfile=\")) {" + NL + "                properties_";
  protected final String TEXT_107 = " += \"&allowLoadLocalInfile=true\";" + NL + "            }" + NL + "        }" + NL + "" + NL + "        String url_";
  protected final String TEXT_108 = " + \"?\" + properties_";
  protected final String TEXT_109 = ";";
  protected final String TEXT_110 = NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_111 = " = null;" + NL + "\tString query_";
  ...
  protected final String TEXT_118 = ".prepareStatement(";
  protected final String TEXT_119 = ");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_120 = "\", pstmt_";
  protected final String TEXT_121 = NL + "        java.sql.Statement stmt_";
  protected final String TEXT_122 = ".createStatement();" + NL + "        resourceMap.put(\"stmt_";
